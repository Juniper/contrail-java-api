...
public class ServiceHealthCheckType extends ApiPropertyBase {
    ...
    public ServiceHealthCheckType(boolean enabled, String health_check_type, String monitor_type, Integer delay, Integer timeout, Integer max_retries, String http_method, String url_path, String expected_codes) {
    ...
    public ServiceHealthCheckType(boolean enabled, String health_check_type, String monitor_type, Integer delay, Integer timeout) {
        this(enabled, health_check_type, monitor_type, delay, timeout, null, null, null, null);     }
    public ServiceHealthCheckType(boolean enabled, String health_check_type, String monitor_type, Integer delay, Integer timeout, Integer max_retries) {
        this(enabled, health_check_type, monitor_type, delay, timeout, max_retries, null, null, null);     }
    public ServiceHealthCheckType(boolean enabled, String health_check_type, String monitor_type, Integer delay, Integer timeout, Integer max_retries, String http_method) {
        this(enabled, health_check_type, monitor_type, delay, timeout, max_retries, http_method, null, null);     }
    public ServiceHealthCheckType(boolean enabled, String health_check_type, String monitor_type, Integer delay, Integer timeout, Integer max_retries, String http_method, String url_path) {
